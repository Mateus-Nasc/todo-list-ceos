...
---
# Dentro do Site
<img width="1323" height="659" alt="Flow site" src="https://github.com/user-attachments/assets/5f9a58b8-d544-4b68-b840-b150d6b6aa67" />

O site depende de 4 funcionalidades básicas:    
Criar tarefa;    
Editar tarefa;    
Deletar tarefa;    
Buscar tarefa;    
...
Apenas clique no que está escrito e digite oque quiser para editar sua tarefa.    
Tenha em mente que se o título e descrição tiverem menos que 4 dígitos, ele voltará pra sua forma anterior ao recarregar a página    
<img width="1327" height="662" alt="Exemplo de card" src="https://github.com/user-attachments/assets/1aabb761-81fc-4605-8435-39577578916f" />

## Deletar Tarefa
Apenas clique no botão vermelho com "X"    
Tenha cuidado, pois não há confirmação de exclusão.    
Além disso, do lado do botão de excluir, há o botão de concluir tarefa.
